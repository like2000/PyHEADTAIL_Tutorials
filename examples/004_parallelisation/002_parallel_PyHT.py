...
from parallel_wake import ParallelWakes
...
# f = Figlet(font='helv', width=80)
# # print(f.renderText("*** Hammer curls at 16 kgs"))
# print(['\033[1m' + "*** Hammer Curls at 16 kgs" for i in range(1000)])
